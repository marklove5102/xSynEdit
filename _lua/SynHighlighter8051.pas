...
{
 has bug - line of first character deleted
}
...
begin
  ...
  EnumerateKeywords(Ord(tkRegister),  RegCodes,    IdentChars, @DoAddKeyword);
  EnumerateKeywords(Ord(tkDirective), DirectCodes, IdentChars, @DoAddKeyword);
