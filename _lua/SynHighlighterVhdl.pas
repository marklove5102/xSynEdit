...
The Original Code is: SynHighlighterVhdl.pas, the Initial
...
$Id: SynHighlighterVhdl.pas,v 1.00 2005/01/24 17:58:27 Kan Exp $
...
-------------------------------------------------------------------------------}
{
@abstract(Provides a VHDL highlighter for SynEdit)
@author(Zhou Kan [textrush@tom.com])
@created(June 2004)
@lastmod(2005-01-24)
The SynHighlighterVhdl unit provides SynEdit with a VHDL (*.vhd;*.vhdl) highlighter.
The highlighter formats VHDL source code highlighting keywords, strings, numbers and characters.
}

{
  has bug, first char in line disappears
}
