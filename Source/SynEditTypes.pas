...
type
  ...
  TBufferCoord = record
    ...
    class function Min(a, b: TBufferCoord): TBufferCoord; static; inline;
    class function Max(a, b: TBufferCoord): TBufferCoord; static; inline;
  end;

  TDisplayCoord = record
    Column: integer;
    Row: integer;
    class operator Equal(a, b: TDisplayCoord): Boolean; inline;
    class operator NotEqual(a, b: TDisplayCoord): Boolean; inline;
    class operator LessThan(a, b: TDisplayCoord): Boolean; inline;
    class operator LessThanOrEqual(a, b: TDisplayCoord): Boolean; inline;
    class operator GreaterThan(a, b: TDisplayCoord): Boolean; inline;
    class operator GreaterThanOrEqual(a, b: TDisplayCoord): Boolean; inline;
    class function Min(a, b: TDisplayCoord): TDisplayCoord; static; inline;
    class function Max(a, b: TDisplayCoord): TDisplayCoord; static; inline;
  end;
